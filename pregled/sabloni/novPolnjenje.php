...
<div id="stolpec3">
 ...
 <fieldset id= "asamal" >
    <legend></legend>
	 ...
	 <input id="euroscore" type="text"   class="ocena"   list="euros"  name="euroscore" size="1" maxlength="5" onfocus="stevilkaFunction(20, 'euroscore', 'euros')"onkeypress=" return isNumber(event, euroscoreVar)" >
	 </label>
     <datalist id="euros">
     <option value='st eur'>
     </datalist>	 
