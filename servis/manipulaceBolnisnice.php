...
case "vloz":
    ...
    $bonisnicaStatus = test_input($_POST["bonisnicaStatus"]);  
    $data= array("mesto"=>$mesto, "nazivB"=>$nazivB, "bonisnicaStatus"=>$bonisnicaStatus);
...
//echo $vybrano[1];
  if(count($vybrano)>0){
   ...
   echo "<tr><th>Id</th><th>mesto</><th>nazivB</th><th>bonisnicaStatus</th></tr>";
