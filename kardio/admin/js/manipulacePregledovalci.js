...
for (i = 0; i < bolList.length; i++) {
 // text += "<option value=" +  zdravList[i] + ">"+"<br>";
  ...
  case "vloz":
    ...
    email= '<input type="int" id="emailId" name="email" value="" placeholder="email" required>';
uname= '<input type="int" id="unameId" name="uname" value="" placeholder="uname" required>';	
